...
const newTab4 = `    <!-- TAB 4: REKAP ABSEN -->
...
content = content.slice(0, startPos) + newTab4 + content.slice(endActual);
fs.writeFileSync('dashboard.html', content, 'utf8');
console.log('SUCCESS: Absen tab replaced. startPos=' + startPos + ' endActual=' + endActual);
